...
function polaroidSlides() {
	...
	TweenMax.set($polaroidSlide[1], {
		left: "60%",
		opacity: 0.5,
		scale: 0.5
	});
	TweenMax.set($polaroidSlide[2], {
		left: "-60%",
		opacity: 0.5,
		scale: 0.5
	});
	TweenMax.set($polaroidSlide[3], {
		opacity: 0,
		scale: 0
	});
...
function nextPolaroid() {
	TweenMax.to($polaroidSlide.eq(currentSlide), 1, {
		left: "-60%",
		opacity: 0.5,
		scale: 0.5,
	});
